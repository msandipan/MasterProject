...
from torchvision.models import DenseNet121_Weights,VGG16_BN_Weights,AlexNet_Weights,GoogLeNet_Weights
...
model_map = {'Dense121': models.densenet121(weights=DenseNet121_Weights.DEFAULT),
             'Dense121_NoPre': models.densenet121(weights = None),
             'VGG16BN': models.vgg16_bn(weights=VGG16_BN_Weights.DEFAULT),
             'VGG16BN_NoPre': models.vgg16_bn(weights = None),
             ...
             #'Resnet50': pretrainedmodels.__dict__['resnet50'](num_classes=1000, weights=ResNet50_Weights.IMAGENET1K_V1),
